...
<template>
    <div v-if="layoutLoaded" class="system">
        ...
        <DeleteConfirmPopup v-if="deleteConfirmPopup" :action="deleteAction" :type="deleteType" :name="deleteName" :id="deleteId" :itemId="deleteItemId" @recordDeleted="recordDeleted" @closeDeleteConfirmPopup="closeDeleteConfirmPopup"/>
...
export default {
    ...
    computed: {
        ...
        message() {
            ...
            if(success_message) {
                toast.add({severity: 'success', summary: success_message, life: 2000});
            } else if(error_message) {
                toast.add({severity: 'error', summary: error_message, life: 2000});
            }
