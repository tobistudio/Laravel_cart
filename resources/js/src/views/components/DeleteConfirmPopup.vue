        ...
        <div class="popup-content-wrapper">
            <div class="popup-content" @click.prevent.stop>
                ...
                <div class="popup-content">
                    ...
                    <div class="text">{{ 'Are you sure u want to delete this ' + type + ' - ' }}<span class="highlight">{{ name }}</span></div>
                    <div class="actions">
    ...
    methods: {
        ...
        deleteRecord() {
            if(this.action === 'removeLanguagePageBlock'){
                this.$emit('recordDeleted', {action: 'removeLanguagePageBlock', id: this.id});
            } else if(this.action === 'removeIconTextBlockItem'){
                this.$emit('recordDeleted', {action: 'removeIconTextBlockItem', id: this.id, item_id: this.itemId});
            } else {
