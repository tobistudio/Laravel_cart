        ...
        <div class="popup-content-wrapper">
            <div class="popup-content">
                <div class="popup-header">
                    <div class="title">Edit Language - {{ language.name }}</div>
                ...
                <div class="popup-content">
                    ...
                    <div class="input-wrapper-container">
                        ...
                        <div :class="['input-wrapper locale', localLocale ? 'has-content' : '', locale_validation ? 'error' : '', localeClassFocus]">
                            ...
                            <input v-model="localLocale" type="text" @focus="localeFocus" @blur="localeBlur"/>
...
export default {
    ...
    methods: {
        ...
        localeFocus() {
            this.localeClassFocus = 'focus';
        },
        localeBlur() {
            this.localeClassFocus = false;
        },
