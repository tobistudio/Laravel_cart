<template>
    <div class="vehicle-models">
        <div :class="['card', 'with-header', vehicleModelsOpen ? 'open' : '']">
                    <div class="header">
                        <div class="title">{{ trans.title }}</div>
                        <div class="controls">
                            <div class="button" @click="toggleVehicleModels" v-if="vehicleModelsOpen">
                    ...
                    <div class="content" v-if="vehicleModelsOpen">
<!--                        <div class="row">-->
<!--                            <div class="full">-->
...
<!--                            </div>-->
<!--                        </div>-->
                        <vehicle-model :vehicleModels="vehicleModels" @openDeleteConfirmPopup="openDeleteConfirmPopup" :removeLanguagePageBlockOrItem="removeLanguagePageBlockOrItem"></vehicle-model>

                        <div class="row">
                            <div class="full">
                                <button class="primary mb-1" @click="addVehicleModel">{{ trans.addVehicleModel }}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        toggleVehicleModels() {
            this.vehicleModelsOpen = !this.vehicleModelsOpen;
        },
    ...
    mounted() {
        ...
        this.$emit('blockUpdated', this.local_data);
    }
}
</script>
