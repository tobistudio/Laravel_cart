...
<template>
    <div class="block-data" v-if="blockLoaded">
        ...
        <div class="row">
            <div class="full">
                <div class="checkbox-data" @click="toggleShowPlateNumberSearch">
                    <div :class="['checkbox', local_data.plate_number_search ? 'checked' : '']">
                        ...
                        <input type="checkbox" v-model="local_data.plate_number_search">
                    </div>
                    <div class="label">{{ trans.search_by_plate_number }}</div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            trans: {
                ...
                search_by_plate_number: 'Show search by plate number',
    ...
    methods: {
        ...
        toggleShowPlateNumberSearch() {
            this.local_data.plate_number_search = !this.local_data.plate_number_search;
        },
