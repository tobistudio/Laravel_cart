                ...
                <div :class="['card', 'with-header', element.active ? 'open' : '']">
                    <div class="header">
                        ...
                        <div class="controls">
                            ...
                            <div class="button"
                                 @click="openDeleteConfirmPopup('removeListBlockItem', 'table-block-item', block.id, element.title ? element.title : trans.new_item, element.id)">
                                <i class='bx bx-x'></i>
                            </div>
                        </div>
                    </div>
                    <div class="content" v-if="element.active">
                        ...
                        <div class="row">
                            <div class="full">
                                <div :class="['input-wrapper', element.block_id ? 'has-content' : '', blockIdClassFocus]">
                                    <div class="label">{{ trans.block_id }}</div>
                                    <div class="label-floating">{{ trans.block_id }}</div>
                                    <input v-model="element.block_id" type="text" @focus="blockIdFocus" @blur="blockIdBlur"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
export default {
    ...
    methods: {
        ...
        blockIdFocus() {
            this.blockIdClassFocus = 'focus';
        },
        blockIdBlur() {
            this.blockIdClassFocus = false;
        },
    },
    mounted() {
