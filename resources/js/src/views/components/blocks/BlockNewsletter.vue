...
<template>
    <div class="block-data" v-if="blockLoaded">
        ...
        <div class="row">
            <div class="full">
                <div :class="['input-wrapper', local_data.input_text ? 'has-content' : '', inputTextClassFocus]">
                    <div class="label">{{ trans.input_text }}</div>
                    <div class="label-floating">{{ trans.input_text }}</div>
                    <input v-model="local_data.input_text" type="text" @focus="inputTextFocus" @blur="inputTextBlur"/>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="full">
                <Editor v-model="local_data.agree_text" :title="trans.agree_text" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        inputTextFocus() {
            this.inputTextClassFocus = 'focus';
        },
        inputTextBlur() {
            this.inputTextClassFocus = false;
        },
        buttonTextFocus() {
