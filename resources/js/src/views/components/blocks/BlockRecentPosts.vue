...
<template>
    <div class="block-data" v-if="blockLoaded">
        ...
        <div class="row">
            <div class="full">
                <div :class="['input-wrapper', local_data.view_all_posts_text ? 'has-content' : '', viewAllPostsTextClassFocus]">
                    <div class="label">{{ trans.view_all_posts_text }}</div>
                    <div class="label-floating">{{ trans.view_all_posts_text }}</div>
                    <input v-model="local_data.view_all_posts_text" type="text" @focus="viewAllPostsTextFocus" @blur="viewAllPostsTextBlur"/>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    data() {
        return {
            ...
            viewAllPostsTextClassFocus: false,

            trans: {
                title: 'Title',
                description: 'Description',
                view_all_posts_text: 'View all posts text',
            }
        }
    },
    components: {
    ...
    methods: {
        ...
        viewAllPostsTextFocus() {
            this.viewAllPostsTextClassFocus = 'focus';
        },
        viewAllPostsTextBlur() {
            this.viewAllPostsTextClassFocus = false;
        },
    },
    mounted() {
