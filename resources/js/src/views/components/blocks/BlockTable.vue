            ...
            <template #item="{element}">
                <div :class="['card', 'with-header', element.active ? 'open' : '']">
                    ...
                    <div class="content" v-if="element.active">
                        ...
                        <BlockTableItemBlocks :block="block" :item="element" @openDeleteConfirmPopup="openDeleteConfirmPopup" :removeLanguagePageBlockOrItem="removeLanguagePageBlockOrItem"></BlockTableItemBlocks>
...
import BlockTableItemBlocks from './BlockTableItemBlocks.vue';
