        ...
        <template #item="{element}">
            <div :class="['card', 'with-header', element.active ? 'open' : '']">
                ...
                <div class="content" v-if="element.active">
                    ...
                    <div class="row" v-if="item.warning">
                        <div class="full">
                    ...
                    <div class="row" v-else>
                        <div class="full">
                            <div :class="['input-wrapper', 'image', image_validation ? 'error' : '']">
                                <input @change="imageUpload($event, element)" type="file" accept="image/*" class="image" :id="['iconImage-' + element.id]" ref="iconImage">
                                <div class="image-placeholder">
                                    <div class="label">{{ trans.icon_image }}</div>

                                    <div class="label-more">{{ trans.icon_image_description }}</div>
                                    <div class="image" @click="triggerImageUpload('iconImage-' + element.id)">
    ...
    data() {
        return {
            ...
            trans: {
                ...
                icon_image: 'Icon',
                icon_image_description: 'Minimum image width 32px',
