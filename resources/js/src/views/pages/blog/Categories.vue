            ...
            <TreeTable :value="pages" :filters="filters">
                <template #header>
                    <div class="right">
                        ...
                        <router-link class="button primary" :to="'/system/blog/categories/blog_category'">Add Category</router-link>
                    </div>
                </template>
                    ...
                    <template #body="slotProps">
                        <div class="languages">
                            <div class="language" v-for="language in slotProps.node.data.languages">
                                <router-link class="button primary" :to="'/system/blog/categories/blog_category/' + slotProps.node.data.id + '/' + language.id">
                                ...
                                <router-link v-if="!language.page_id" class="button primary" :to="'/system/blog/categories/blog_category/' + slotProps.node.data.id + '/' + language.id">
...
export default {
    ...
    methods: {
        getPages() {
            this.$store.dispatch('getPages', 'blog_category')
                .then((data) => {
