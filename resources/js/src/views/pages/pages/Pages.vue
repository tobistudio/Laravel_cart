            ...
            <TreeTable :value="pages" :filters="filters">
                <template #header>
                    <div class="right">
                        ...
                        <router-link class="button primary" :to="'/system/pages/page'">Add Page</router-link>
                    </div>
                </template>
                ...
                <Column field="name" header="Name" expander>
                    <template #body="slotProps">
                        <div class="name">
                            {{ slotProps.node.data.name }}<span class="type" v-if="slotProps.node.data.type !== 'page'">{{ '(' + trans[slotProps.node.data.type] + ')' }}</span>
                        </div>
                    </template>
                </Column>
                    ...
                    <template #body="slotProps">
                        <div class="languages">
                            <div class="language" v-for="language in slotProps.node.data.languages">
                                <router-link class="button primary" :to="'/system/pages/page/' + slotProps.node.data.id + '/' + language.id">
                                ...
                                <router-link v-if="!language.page_id" class="button primary" :to="'/system/pages/page/' + slotProps.node.data.id + '/' + language.id">
...
export default {
    ...
    data() {
        return {
            ...
            trans: {
                ...
                blog: 'Blog page',
                search: 'Search page',
                choose_vehicle: 'Choose vehicle page',
                log_in: 'Log in page',
    ...
    methods: {
        getPages() {
            this.$store.dispatch('getPages', null)
                .then((data) => {
