                    ...
                    <template #body="slotProps">
                        <div class="languages">
                            <div class="language" v-for="language in slotProps.node.data.languages">
                                <router-link class="button primary" :to="'/system/shop/categories/product_category/' + slotProps.node.data.id + '/' + language.id">
                                ...
                                <router-link v-if="!language.page_id" class="button primary" :to="'/system/shop/categories/product_category/' + slotProps.node.data.id + '/' + language.id">
