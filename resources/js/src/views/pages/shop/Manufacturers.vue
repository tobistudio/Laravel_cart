            ...
            <TreeTable :value="pages" :filters="filters">
                <template #header>
                    <div class="right">
                        ...
                        <router-link class="button primary" :to="'/system/shop/manufacturers/manufacturer'">Add manufacturer</router-link>
                    </div>
                </template>
                <template #empty> No Manufacturers found. </template>
                    ...
                    <template #body="slotProps">
                        <div class="languages">
                            <div class="language" v-for="language in slotProps.node.data.languages">
                                <router-link class="button primary" :to="'/system/shop/manufacturers/manufacturer/' + slotProps.node.data.id + '/' + language.id">
                                    <svg v-if="language.page_id" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="edit" viewBox="0 0 24 24"><path stroke="currentColor" d="M8.707 19.707 18 10.414 13.586 6l-9.293 9.293a1.003 1.003 0 0 0-.263.464L3 21l5.242-1.03c.176-.044.337-.135.465-.263zM21 7.414a2 2 0 0 0 0-2.828L19.414 3a2 2 0 0 0-2.828 0L15 4.586 19.414 9 21 7.414z"></path></svg>
                                </router-link>

                                <router-link v-if="!language.page_id" class="button primary" :to="'/system/shop/manufacturers/manufacturer/' + slotProps.node.data.id + '/' + language.id">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="create" viewBox="0 0 24 24"><path stroke="currentColor" d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path></svg>
                                </router-link>
                            </div>
                        </div>
                    </template>
...
export default {
    ...
    methods: {
        getPages() {
            this.$store.dispatch('getPages', 'manufacturer')
                .then((data) => {
